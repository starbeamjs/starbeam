...
/**
 * This code provides a guaranteed-unique ID, even if there are multiple copies
 * of `@starbeam/shared`.
 *
 * This code intentionally does not use a UUID to make it easier to use these
 * IDs in debugging context, which is their primary purpose.
 */
