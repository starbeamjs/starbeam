...
import { type ResourceReturn, Resource } from "../resource/resource.js";
import { Static } from "../static.js";

export function ResourceList<T, U>(
  list: Iterable<T>,
  {
    key,
    map,
  }: { key: (item: T) => unknown; map: (item: T) => ResourceReturn<U> }
): ResourceBlueprint<Reactive<U>[]> {
...
//         const resource = linkable.create(this);
