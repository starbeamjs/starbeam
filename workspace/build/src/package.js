...
import { build } from "./rollup/rollup.js";
import { parse } from "./utils.js";

/**
 * @typedef {import("./manifest.js").PackageJSON} PackageJSON
 * @typedef {import("./package.js").ExternalOption} ExternalOption
...
export class Package {
   ...
   */
  static build(meta) {
    return Package.at(meta)?.rollup();
  }

  /** @readonly @type {import("./config.js").PackageInfo} */
  #package;

  /***
   * @param {import("./config.js").PackageInfo} pkg
   */
  constructor(pkg) {
    this.#package = pkg;
  }
